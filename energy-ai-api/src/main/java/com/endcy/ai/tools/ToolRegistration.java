...
import com.endcy.ai.config.AiWebSearchApiProperties;
import com.endcy.ai.mcp.manager.ElectricityPriceSearchTool;
...
public class ToolRegistration {
    ...
    @Bean("ragTools")
    public ToolCallback[] ragTools(ElectricityPriceSearchTool electricityPriceSearchTool,
                                   ExcelGenerationTool excelGenerationTool) {
        GisGeoTool gisGeoTool = new GisGeoTool(aiWebSearchApiProperties.getGisGeoCoderUrl());
        SimpleWebSearchTool simpleWebSearchTool = new SimpleWebSearchTool(aiWebSearchApiProperties.getSimpleKey());
        WebScrapingTool webScrapingTool = new WebScrapingTool();
        DateTimeTool dateTimeTool = new DateTimeTool();
        MathCalculatorTool mathCalculatorTool = new MathCalculatorTool();
