package com.endcy.ai.listener;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.endcy.ai.listener.strategy.IAiMsgConsumerStrategy;
import com.endcy.service.common.constant.MQConstant;
import com.endcy.service.domain.bo.BaseMqMsgRequest;
...
@Slf4j
@Component
@RabbitListener(queues = MQConstant.MQ_API_REFRESH_DUCOMENT)
