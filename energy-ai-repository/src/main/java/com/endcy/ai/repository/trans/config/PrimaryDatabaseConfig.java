package com.endcy.ai.repository.trans.config;
...
import com.endcy.service.common.config.CustomizedSqlInjector;
...
@MapperScan(basePackages = {"com.endcy.ai.repository.trans.mapper", "com.endcy.service.common.**.mapper"})
