...
-- ------------------------------------------------------
INSERT INTO `ai_knowledge_category_config` (`type`, `code`, `name`, `description`, `sort_order`, `enabled`)
VALUES ('scope', 'MARKET_CUSTOMER_SERVICE', '市场客服', '市场营销、市场推广相关客服知识', 1, 1),
       ('scope', 'ACCOUNT_CUSTOMER_SERVICE', '用户客服', 'C端用户相关客服知识', 2, 1),
       ('scope', 'OPERATOR_CUSTOMER_SERVICE', '商户客服', 'B端商户相关客服知识', 3, 1),
...
-- ------------------------------------------------------
INSERT INTO `ai_knowledge_category_config` (`type`, `code`, `name`, `description`, `sort_order`, `enabled`)
VALUES ('business', 'HELLO', '普通问候', '基本问候打招呼或者非充电运营能源领域业务内容咨询', 1, 1),
       ...
       ('business', 'UNKNOWN', '其他', '未分类或其他业务', 16, 1)
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
